        ...
        <div class="pic" ref="Ref_pic">
            ...
            <form class="form">
                ...
                <div class="password glass">
                    ...
                    <div class="text"><input v-model="password" :type="showEyes" placeholder="密码" name="password"
                            id="password" onfocus="if(this.value=='密码'){this.value='';}" required autofocus></div>
